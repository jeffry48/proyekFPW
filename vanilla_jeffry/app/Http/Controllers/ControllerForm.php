...
<<<<<<< Updated upstream
    ...
    public function jualProperty(Request $req)
    {
        ...
        $ada = false;
        foreach ($data_properti as $properti){
            if($properti->jenis_properti == $req->jenis
            && $properti->alamat_properti == $req->alamat
            && $properti->harga_properti == $req->harga
            && $properti->kategori_properti == $req->kategori){
                // sudah pernah ada di database properti
                $ada = true;
                $insertData = [
                    "id_jual" => $idJual,
