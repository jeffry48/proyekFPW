...
('P0001', 'Rumah', 'kontrak', 'Rumah di jalan besar', 0, 0, 'jl. Rimbun no 20', 100000000, '2020-11-05', '', '231', 1),
('P0002', 'Tanah', 'kontrak', 'Tanah besar di jalan Besar', 0, 0, 'Jl. lawu raya no 3B', 200000000, '2020-11-05', '', '151', 1),
('P0003', 'Rumah', 'beli', 'Rumah kedua', 0, 0, 'jl. Rawon', 300000000, '2020-11-05', '', '566', 0),
('P0004', 'Rumah', 'beli', 'rumah besar di jalan besar', 5, 2, 'jalan besar no 20', 100000000, '2020-11-21', '', '121', 1),
('P0005', 'Apartemen', 'beli', 'rumah kecil di jalan kecil', 3, 1, 'jalan kecil no 30', 100000000, '2020-11-23', '', '151', 1),
('P0006', 'rumah', 'kontrak', 'sadasda', 10, 10, 'jalan rumah kecil', 1000000, '2020-11-27', '20201115143348.png', '0', 0),
('P0007', 'rumah', 'beli', 'aaaaaa', 15, 12, 'jl aaaaaaaaa', 100000000, '2020-11-27', '20201115143348.png', '0', 1),
...
('P0010', 'apartemen', 'beli', 'apartmen kecil', 10, 20, 'jalan kecil', 100000, '2020-12-12', '20201115143348.png', '0', 1);
...
INSERT INTO `user_properti_beli` (`id_beli`, `id_user`, `id_properti`, `metode_pembelian`, `pajak_beli`, `total_beli`, `pesan_untuk_penjual`) VALUES
('B0001', 'U0001', 'P0006', 'cash', 10000000, 110000000, 'aaaaa'),
('B0002', 'U0002', 'P0003', 'cash', 30000000, 330000000, 'beli dong!'),
('B0003', 'U0003', 'P0003', 'cash', 30000000, 330000000, 'beli dari 2 dong!'),
('B0004', 'U0004', 'P0003', 'cash', 30000000, 330000000, 'beli dong3'),
('B0005', 'U0001', 'P0004', 'cash', 10000000, 110000000, 'sad'),
('B0006', 'U0005', 'P0003', 'kredit', 30000000, 360000000, 'beli kredit'),
('B0007', 'U0004', 'P0004', 'cash', 10000000, 110000000, 'aaaaa'),
('B0008', 'U0004', 'P0009', 'kredit', 2131312, 25575748, 'aaaa'),
('B0009', 'U0004', 'P0007', 'cash', 10000000, 110000000, NULL);
...
INSERT INTO `user_properti_kontrak` (`id_kontrak`, `id_user`, `id_properti`, `tgl_awal`, `durasi_kontrak`, `tgl_akhir`, `harga`) VALUES
('', 'U0001', 'P0001', '2021-01-12', 12, '2021-01-12', 1200000000);
